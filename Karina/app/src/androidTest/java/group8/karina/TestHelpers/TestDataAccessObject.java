...
public class TestDataAccessObject extends DataAccessObject
{
	...
	{
		String statement = "DROP TABLE Transactions;";
	...
	{
		String statement = "CREATE TABLE USERS(USERID INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,USERNAME VARCHAR(30))";
		statement += "CREATE TABLE CATEGORIES(CATEGORYID INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,CATEGORYNAME VARCHAR(30),CATEGORYISEXPENSE BOOLEAN NOT NULL)";
		statement += "CREATE TABLE TRANSACTIONS(TRANSID INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,TRANSDATE DATE,TRANSAMOUNT DOUBLE,TRANSISEXPENSE BOOLEAN NOT NULL,TRANSCATEGORYID INTEGER NOT NULL,TRANSUSERID INTEGER NOT NULL,TRANSCOMMENT VARCHAR(150),FOREIGN KEY(TRANSUSERID) REFERENCES USERS(USERID),FOREIGN KEY(TRANSCATEGORYID) REFERENCES CATEGORIES(CATEGORYID))";
		statement += "INSERT INTO USERS VALUES(1,'Default');";
